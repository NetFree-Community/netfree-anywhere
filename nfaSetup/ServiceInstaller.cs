...
public static class ServiceInstaller
{
    ...
    public static void Uninstall(string serviceName)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                var changedStatus = WaitForServiceStatus(service, ServiceState.Stopped, ServiceState.NotFound);
            }
            finally
            {
    ...
    public static void InstallService(string serviceName, string displayName, string fileName, ServiceBootFlag typeStart, ServiceType typeService)
    {
        IntPtr scm = OpenSCManager(ScmAccessRights.AllAccess);
    ...
    private static void StartService(IntPtr service)
    {
        ...
        if (!changedStatus)
            throw new ApplicationException("Unable to start service " + Marshal.GetLastWin32Error());
    }
    ...
    private static void StopService(IntPtr service)
    {
        ...
        if (!changedStatus)
            throw new ApplicationException("Unable to stop service " + Marshal.GetLastWin32Error());
    }
    ...
    private static bool WaitForServiceStatus(IntPtr service, ServiceState waitStatus, ServiceState desiredStatus)
    {
        ...
        //************************
        int counter = 0;
        while (status.dwCurrentState == waitStatus && counter != 10)
        {
            counter++;
            Thread.Sleep(500);
            QueryServiceStatus(service, status);
